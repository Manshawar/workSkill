---
name: vf-mry
description: "前端问题经验沉淀（vf 族，memory）。已确认问题/原因/约束写入本地 .verify/knowledge/。Use when: vf-mry, 沉淀经验, 记规则, 记录修复约束, 记下来这个 bug, 查类似问题规则, repair memory, E2E 失败后沉淀。Not for: 自动修 bug(→vf-fix), 写测试(→vf-e2e), 扫全库, 提交 .verify/。"
---
...
禁止：扫全库 · 记一次性细节 · 大段代码 · 重复 index · 教程式长文 · 改业务代码
